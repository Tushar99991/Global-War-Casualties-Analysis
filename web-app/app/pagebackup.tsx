...
function LiveGlobalData() {
  ...
  return (
    <section className="relative max-w-6xl mx-auto px-6 pb-20">
      <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/70 backdrop-blur-xl shadow-lg shadow-purple-200/10">
        ...
        <div className="relative px-7 py-7 md:px-9 md:py-8">
          ...
          <div className="mt-7 grid md:grid-cols-3 gap-4">
            <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-br from-white to-purple-50/60 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-200/20">
              <div className="absolute -top-10 -right-10 w-24 h-24 bg-purple-300/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-br from-white to-blue-50/50 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-200/20">
              <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-blue-300/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-br from-white to-slate-50 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200/20">
              <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-slate-300/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
  ...
  return (
    <div className="home-typography relative min-h-screen bg-slate-950">
      ...
      <div className="relative z-10">
        ...
        <section className="relative max-w-6xl mx-auto px-6 pb-20">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link
              ...
              className="group relative bg-white/80 backdrop-blur-md rounded-2xl p-7 border border-slate-200/80 shadow-sm hover:shadow-2xl hover:shadow-red-200/20 hover:-translate-y-2 transition-all duration-500 overflow-hidden"
            >
            ...
            <Link
              href="/russia-ukraine"
              className="group relative bg-white/80 backdrop-blur-md rounded-2xl p-7 border border-slate-200/80 shadow-sm hover:shadow-2xl hover:shadow-blue-200/20 hover:-translate-y-2 transition-all duration-500 overflow-hidden"
            >
        ...
        <section className="relative max-w-6xl mx-auto px-6 pb-20">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="group relative bg-white/80 backdrop-blur-md rounded-2xl p-7 border border-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-red-200/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div className="group relative bg-white/80 backdrop-blur-md rounded-2xl p-7 border border-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-blue-200/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div className="group relative bg-white/80 backdrop-blur-md rounded-2xl p-7 border border-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-emerald-200/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        {/* Overview */}
        <section className="relative bg-white/70 backdrop-blur-sm border-t border-slate-200/80">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-50/40 via-transparent to-indigo-50/40 pointer-events-none" />
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-16">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="group relative bg-gradient-to-br from-slate-50 to-white rounded-2xl p-7 border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-purple-200/10 transition-all duration-500 overflow-hidden">
                <div className="absolute -top-16 -right-16 w-40 h-40 bg-purple-200/20 rounded-full blur-3xl pointer-events-none" />
