...
import { BarChart3, ChevronDown, Image, MapPin, Menu, X } from "lucide-react";
              ...
              <div className="relative group ml-1">
                <button
                  ...
                  className={`relative flex items-center justify-center gap-1.5 px-3.5 py-1.5 rounded-lg transition-all duration-200 ${
                    isGalleryActive
                      ? "bg-gradient-to-r from-rose-500/20 to-orange-500/20 text-white shadow-sm border border-rose-400/20"
                ...
                >
                  ...
                  {isGalleryActive && (
                    <span className="absolute left-1/2 -bottom-[1px] -translate-x-1/2 w-5 h-0.5 rounded-full bg-gradient-to-r from-rose-400 to-orange-400" />
                  )}
                </button>
                ...
                <div className="absolute right-0 top-full pt-2 opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200">
                  <div className="w-64 rounded-2xl bg-white/95 backdrop-blur-xl border border-slate-200/80 shadow-xl shadow-slate-900/10 p-2">
                    ...
                    <Link
                      ...
                      className="group/item flex items-center gap-3 rounded-xl px-3 py-3 hover:bg-gradient-to-r hover:from-rose-50 hover:to-orange-50 transition-all duration-200"
                    >
                      <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-rose-100 to-orange-100 text-rose-600 flex items-center justify-center group-hover/item:scale-105 transition-transform">
                        <MapPin size={17} />
                      </div>
                    ...
                    <Link
                      ...
                      className="group/item flex items-center gap-3 rounded-xl px-3 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                    >
                      <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 text-blue-600 flex items-center justify-center group-hover/item:scale-105 transition-transform">
                        <MapPin size={17} />
                      </div>
