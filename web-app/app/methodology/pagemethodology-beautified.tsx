...
export default function MethodologyPage() {
  const roadmap = [
    ...
    },
    {
      ...
      description: "Standardize fields, handle missing values, and derive variables.",
      icon: Filter,
      color: "purple",
      bg: "bg-purple-50/80",
      ...
      <section className="mx-auto max-w-6xl px-5 pb-12 pt-10 sm:px-6 sm:pt-14 lg:pt-20">
        ...
        <div className="relative">
          ...
          <div className="mt-7 flex flex-wrap gap-2.5">
            {["Data-driven", "Reproducible", "Transparent", "BI-ready"].map((item) => (
              <span
                key={item}
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-5 transition-all duration-300 hover:border-blue-100 hover:bg-blue-50/40">
              ...
              <ul className="space-y-2.5">
                <li className="flex gap-2.5">
                  ...
                  <span>Uppsala Conflict Data Program (UCDP) – Georeferenced Event Dataset</span>
                </li>
                <li className="flex gap-2.5">
                  <CheckCircle2 size={16} className="mt-0.5 shrink-0 text-blue-500" />
                  <span>Our World in Data – War & Peace (aggregated conflict deaths)</span>
                </li>
              </ul>
            </div>

            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-5 transition-all duration-300 hover:border-blue-100 hover:bg-blue-50/40">
              <p className="mb-3 font-bold text-slate-800">Israel – Palestine</p>
              <ul className="space-y-2.5">
                <li className="flex gap-2.5">
                  <CheckCircle2 size={16} className="mt-0.5 shrink-0 text-blue-500" />
                ...
                <li className="flex gap-2.5">
                  <CheckCircle2 size={16} className="mt-0.5 shrink-0 text-blue-500" />
                  <span>Tech for Palestine – Killed in Gaza (individual demographic records)</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="group relative overflow-hidden rounded-[1.75rem] border border-slate-200/70 bg-white/80 p-6 shadow-[0_18px_50px_-30px_rgba(15,23,42,0.3)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-[0_25px_70px_-30px_rgba(16,185,129,0.22)] sm:p-8">
          ...
          <div className="relative mt-7 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-100 hover:bg-emerald-50/40">
              <span className="block text-xs font-bold uppercase tracking-wider text-emerald-600">Raw</span>
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-100 hover:bg-emerald-50/40">
              <span className="block text-xs font-bold uppercase tracking-wider text-emerald-600">Cleaned</span>
              <span className="mt-1.5 block text-sm text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-100 hover:bg-emerald-50/40">
              <span className="block text-xs font-bold uppercase tracking-wider text-emerald-600">BI-Ready</span>
              <span className="mt-1.5 block text-sm text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-100 hover:bg-emerald-50/40">
              <span className="block text-xs font-bold uppercase tracking-wider text-emerald-600">Dashboard</span>
              <span className="mt-1.5 block text-sm text-slate-600">Interactive Tableau Public dashboard + static charts</span>
            </div>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-[1.75rem] border border-slate-800/80 bg-slate-950 p-6 text-white shadow-[0_25px_80px_-30px_rgba(15,23,42,0.65)] sm:p-8">
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-lg font-bold sm:text-xl">Limitations &amp; Notes</h2>
            </div>
          </div>
